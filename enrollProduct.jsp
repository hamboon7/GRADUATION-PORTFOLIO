					...
					<div class="dashboard">
						<div class="dashboard__content">
							...
							<c:forEach items="${enrollAuctionData}" var="enrollAuctionVO">
								<div class="cardee ripple">
									<span class="badg badge-group">
										<c:out value="공동 구매" />
									</span>
									<a href="Controller?cmd=myPageEnrollPurchaseAction&number=${enrollAuctionVO.auction_num}">
										<input type="hidden" name="num" value="${enrollAuctionVO.auction_num}">
										<img class="auction_img" src="img/productImage.png" height="170" width="170" />
									</a>
									<div class="pname">
