				...
				<div class="column">
					<div class="dashboard">
						<div class="dashboard__content">
							...
							<a class="purchase" href="Controller?cmd=myPageBuyPurchaseAction&number=${buyProductVO.num}">
									<div class="cardee ripple">
										...
										<div class="pname">
											...
											<br />
											<h6>
										나의 거래 상태 : <span class="badge badge-primary"> 
										<c:out value="${buyProductVO.buyer_condition}" /></span>
									</h6>
									<h6>
										<c:choose>
							...
							<c:forEach items="${buyBazaarData}" var="buyProductVO">
									...
									<h6>
										...
										<c:out value="${buyProductVO.seller_condition}" /></span>
									</h6>
											<h6 class="lead">
												<fmt:formatNumber value="${buyProductVO.price}"
													pattern="###,###,###" />
