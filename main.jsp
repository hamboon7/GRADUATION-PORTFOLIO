...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<a href="Controller?cmd=mainPopUpUI">
				<img src="img/b4.png" height="150" width="300"
					class="d-block w-100" alt="...">
			</a>
			</div>
			<div class="carousel-item">
				<img src="img/b1.png" height="150" width="300"
					class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
				<img src="img/b2.png" height="150" width="300"
					class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
				<img src="img/b3.png" height="150" width="300"
					class="d-block w-100" alt="...">
			</div>
		</div>
	</div>
	...
	<div class="page main">
		<c:forEach items="${productData}" var="mainVO">
			<div class="cardee ripple">
				...
				<div class="pname">
					...
					<h6 class="lead"><fmt:formatNumber value="${mainVO.price}" pattern="###,###,###" /></h6>
				</div>
			</div>
		</c:forEach>
		...
		<c:forEach items="${groupBuyingData}" var="mainVO">
			<div class="cardee ripple">
				<span class="badge"></span>
				<a href="Controller?cmd=groupPurchaseAction&number=${mainVO.groupBuying_num}">
					<img src="img/${mainVO.groupBuying_img}" height="200" width="200"/>
				</a>
				<div class="pname">
					<c:out value="${mainVO.product_name}" /> <br/>
					<h6 class="lead"><fmt:formatNumber value="${mainVO.price}" pattern="###,###,###" /></h6>
				</div>
			</div>
		</c:forEach>
